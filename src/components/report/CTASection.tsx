  ...
  return (
    <section className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-teal to-teal-500">
      ...
      <div className="relative px-8 py-16 sm:px-12 sm:py-20 text-center">
        ...
        <Link
          href={buttonHref}
          className="inline-flex items-center gap-2 px-8 py-4 rounded-xl font-semibold text-teal bg-white hover:bg-neutral-50 transition-all duration-200 shadow-elevated hover:shadow-lg text-lg"
        >
          {buttonText}
